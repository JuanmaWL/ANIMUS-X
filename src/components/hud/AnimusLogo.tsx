  ...
  return (
    <div className={cn("relative flex items-center justify-center", className)}>
      ...
      <svg viewBox="0 0 100 100" className="absolute inset-0 w-full h-full text-animus-cyan" fill="currentColor">
        ...
        {/* Big X behind */}
        <text x="50" y="52" textAnchor="middle" dominantBaseline="central" alignmentBaseline="central" className="font-display font-black text-animus-red opacity-80" fontSize="76" style={{ filter: 'drop-shadow(0px 0px 4px rgba(232,69,60,0.8))' }}>
          X
        </text>
      </svg>
